...
@section('title', 'INPEBAN - Informasi Pelayanan Tuban')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('inpeban.index') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('inpeban.laporan') }}">Laporan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('inpeban.logout') }}"
...
<div class="container">
    <div class="row justify-content-between">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow">
                ...
                @endforeach
                @endif
                @if (Session::has('aduan'))
                <div class="alert alert-{{ Session::get('type') }}">{{ Session::get('aduan') }}</div>
                @endif
                <div class="card mb-3">Tulis Laporan Disini</div>
                <form action="{{ route('inpeban.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #6b9080" href="#">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
    ...
    <div class="row mt-5">
        <div class="col-lg-8">
            <a class="d-inline tab {{ $siapa != 'me' ? 'tab-active' : ''}} mr-4" href="{{ route('inpeban.laporan') }}">
                Semua
            </a>
            <a class="d-inline tab {{ $siapa == 'me' ? 'tab-active' : ''}}" href="{{ route('inpeban.laporan', 'me') }}">
                Laporan Saya
            </a>
            <hr>
        </div>
        ...
        <div class="col-lg-8">
            <div class="laporan-top">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <p>{{ $v->tgl_aduan->format('d M, h:i') }}</p>
                    </div>
                </div>
            </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">Inpeban@Copyright 2023</p>
    </div>
</div>
@endsection
