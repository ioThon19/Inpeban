...
<body>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td><a href="" class="btn btn-secondary">Proses</a></td>
            <td><a href="" class="btn btn-secondary">Tolak</a></td>
          </tr>
          <tr>
            <th scope="row">2</th>
            <td>Nafisah</td>
  ...
  <script src="{{asset('assets/js/masuk.js')}}"></script>
</body>
<footer>
